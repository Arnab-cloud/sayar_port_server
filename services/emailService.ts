...
registerFont("fonts/ArialCE.ttf", { family: "Arial CE" });
...
export async function sendBadgeEmail(
	...
	try {
		...
		const mailOptions = {
			...
			html: `
        <div style="font-family: ArialCE, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
